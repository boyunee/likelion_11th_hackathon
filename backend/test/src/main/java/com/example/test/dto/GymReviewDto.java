...
public class GymReviewDto {
    ...
    public GymReviewDto(Integer starRatingValue, Integer buttonValue1, Integer buttonValue2, Integer buttonValue3, String textarea1, String textarea2, String textarea3, String textarea4){
